...
public class MotorTurret extends BaseTurret {
    ...
    private Rotation2 currentRotation = Rotation2.ZERO;
    ...
    public MotorTurret(DashboardMap dashboardMap) {
        ...
        // TODO We don't need to set the sensor position. We can just use the offset below
    ...
    protected void run(DesiredState desiredState) {
        ...
        currentRotation = Rotation2.fromDegrees(talon.getSelectedSensorPosition() / ENCODER_COUNTS_PER_DEGREE);
    }
